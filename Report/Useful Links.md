...
Focuses more on identifying types of game content and which existing methods of procedural generation are used for each type rather than explorations of those approaches, but a good jumping off point.
